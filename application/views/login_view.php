...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/bg.png');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <p style="color: white;">Sistem Informasi Perpustakaan Kejaksaan Negeri Jember</p>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: White;"> Copyright &copy; Sisper Kejari Jember <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
