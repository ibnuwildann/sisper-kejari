	    ...
	    <div class="col-md-12">
	        <div class="box box-primary">
                <div class="box-header with-border">
                    <a href="user/tambah"><button class="btn btn-primary"><i class="fa fa-plus-square-o"> </i> Add user</button></a>
                    ...
                    <table id="example1" class="table table-bordered table-striped table" width="100%">
                        ...
                        <?php $no=1;foreach($user as $isi){?>
                            <tr>
                                ...
                                <td><?= $isi['alamat'];?></td>
                                <td style="width:14%;">
                                    <a href="<?= base_url('user/edit/'.$isi['id_login']);?>"><button class="btn btn-success"><i class="fa fa-pencil"></i></button></a>

                                    <a href="<?= base_url('user/del/'.$isi['id_login']);?>" onclick="return confirm('Anda yakin user akan dihapus ?');">
									<button class="btn btn-danger"><i class="fa fa-ban"></i></button></a>
