...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url('assets_style/image/logo.ico');?>" />
  <title><?php echo $title_web;?> | Sisper Kejari Jember</title>
  ...
  <![endif]-->
  <!-- Google Font -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Josefin+Sans&family=Supermercado+One&display=swap">
	<!-- offline -->
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      ...
      <span id="logo-lg"><marquee scrolldelay="100">Sistem Informasi Perpustakaan Kejaksaan Negeri Jember</marquee></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          <li>
            ...
            <a href="<?= base_url('user/edit/'.$idbo);?>">
              Halo , <i class="fa fa-user"> </i> <?php echo $d->nama; echo ' | ( '.$d->level.' )'; ?></a>
          </li>
          <li>
            <a href="<?php echo base_url();?>login/logout"><i class="fa fa-sign-out"> </i> Sign out</a>
          </li><li>
            <a href="https://api.whatsapp.com/send/?phone=6289654173040&text=lapor%20kerusakan&type=phone_number&app_absent=0"><i class="fa fa-bug"> </i> Lapor</a>
          </li>
